...
\end{equation*}
    ...
    Seja $B = XX^{T}$, a partir do item anterior podemos concluir que $x_{i}x_{j}^{T} = x_{j}x_{i}^{T}$, logo B é uma matriz simétrica. Nós podemos aplicar o SVD em B de modo que $B = U \Sigma U^{T}$, então teremos a matriz $X = UL^{\frac{1}{2}}$.
